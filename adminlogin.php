...
<div class="animated bounceInDown">
  <div class="container">
    ...
    <form name="form1"  action ="<?php echo $_SERVER['PHP_SELF'] ?>" method ="POST" class="box" onsubmit="return checkStuff()">
      <h4>Admin<span>Dashboard</span></h4>
      <h5>Sign in to your account.</h5>
        <input type="text" name="user" placeholder="username" autocomplete="off" required>
        <i class="typcn typcn-eye" id="eye"></i>
        <input type="password" name="pass" placeholder="Passsword" id="pwd" autocomplete="off" required>
